...
<body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="./">
                        <img src="{{URL::asset('img/logo.png')}}" style="width: 50%; height:100px" alt="Logo">
                    </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align:center">
                    <h2>About Us</h2>
                    <p style="text-align:center">We are {{env('APP_NAME')}}.<br>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/6122cb47649e0a0a5cd25fff/default';
            s1.charset = 'UTF-8';
