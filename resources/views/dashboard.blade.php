...
<div class="main-content">
  <section class="section">
    ...
    <div class="alert alert-warning">
      Note: To continue to use Bizpay, please endeavour to Update your Bank information on the platform, so as to be able to receive payment into your Bank accounts. To do this Click on "Profile" on the Top-right corner of your screen and locate "Update Bank details", to update your account. Thank you.
    </div>
    @endif
              ...
              <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <img src="{{URL::asset('assets/img/banner/1.png')}}" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <img src="{{URL::asset('assets/img/banner/2.png')}}" alt="">
                  </div>
                </div>
              </div>
            </div>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ route('withdraw') }}">
                    <div class="badge badge-success">Withdraw Now</div>
                  </a>
                </td>
              </tr>
            </table>
