                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-item">
                            <div class="footer-links">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('about')}}">Financial Advice</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about')}}">Planning Strategies</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about')}}">Investment Trending</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about')}}">Wealth Commitment</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about')}}">Investment</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about-loan')}}">Loan</a>
                                    </li>
