        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title-wrap text-center section-space--mb_60">
                    ...
                    <h3 class="heading">Our <span style="color: #2c7920;"> company</span></h3>
                </div>
                <!-- section-title-wrap Start -->
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="cybersecurity-about-text" style="text-align: justify;">
                        <div class="text">We are <?php print $siteName;?>.<br>
                        ...
                        <div class="text">The company is leveraging on the accessibility of its internet-based distribution channel, and a low minimum savings amount required.<br>
                         Until now, asset and wealth management in Nigeria has been accessible mainly to a few high net-worth individuals and the corporates. With the minimum amount required by banks for such accounts set at some millions of naira, many low-income savers were effectively excluded.</div>

                        <div class="text">Now, with as low as N10,000, someone can sign on to its platform and begin to earn, says CEO and co-Founder, with the board of trustee. “It is meant for everybody,”. “The idea is that everyone can save and earn a decent interest on it.” We are using this medium to make everyone understand that this platform is not a Ponzi scheme. we are not going to use anyone’s fund to pay another.<br>
