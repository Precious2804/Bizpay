...
class AdminController extends Controller
{
    ...
    {
        $allInvest = ['allInvest' => AllTransactions::all()];
        return view('admin.invest')->with($allInvest);
    }
    ...
    public function cancel_invest(Request $req)
    {
        $data = AllTransactions::where('trans_id', $req->trans)->first();
    ...
    public function activate_invest(Request $req)
    {
        $data = AllTransactions::where('trans_id', $req->trans)->first();
    ...
    public function confirm_invest(Request $req)
    {
        $data = AllTransactions::where('trans_id', $req->trans)->first();
    ...
    public function approve_with(Request $req)
    {
        $data = WithdrwaRequest::where('unique_id', $req->withdraw)->first();
    ...
    public function delete_with(Request $req)
    {
        $findID = WithdrwaRequest::where('unique_id', $req->withdraw)->first();
        $findID->delete();
